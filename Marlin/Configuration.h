...
#define STRING_CONFIG_H_AUTHOR "(stro, CR-10 S4/SKR Mini E3 V3)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CR-10 S4/SKR Mini E3 V3"
...
#define INVERT_E0_DIR true // SKR Mini E3 V3
